package swords.shenanigans.sword.sound;
...
public class ModSounds {
    ...
    public static final RegistryKey<JukeboxSong> BAR_BRAWL_KEY =
            RegistryKey.of(RegistryKeys.JUKEBOX_SONG, Identifier.of(SwordsShenanigans.MOD_ID, "bar_brawl"));

    private static SoundEvent registerSoundEvent(String name) {
        Identifier id = Identifier.of(SwordsShenanigans.MOD_ID, name);
        return Registry.register(Registries.SOUND_EVENT, id, SoundEvent.of((id)));
    }

    public static void registerSounds() {
        SwordsShenanigans.LOGGER.info("Registering Mod sounds for " + SwordsShenanigans.MOD_ID);
    }
}

...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.PINK_GARNET_ORE, oreDrops(ModBlocks.PINK_GARNET_ORE, ModItems.RAW_WEAPON_INGOT));
        addDrop(ModBlocks.PINK_GARNET_DEEPSLATE_ORE, multipleOreDrops(ModBlocks.PINK_GARNET_DEEPSLATE_ORE, ModItems.RAW_WEAPON_INGOT, 3, 7));
        addDrop(ModBlocks.PINK_GARNET_NETHER_ORE, multipleOreDrops(ModBlocks.PINK_GARNET_NETHER_ORE, ModItems.RAW_WEAPON_INGOT, 3, 8));
        addDrop(ModBlocks.PINK_GARNET_END_ORE, multipleOreDrops(ModBlocks.PINK_GARNET_END_ORE, ModItems.RAW_WEAPON_INGOT, 4, 9));
        ...
        this.addDrop(ModBlocks.HONEY_BERRY_BUSH, block -> this.applyExplosionDecay(
